...
export class ProjetsComponent {
  projects = [
    {
      title: 'IA Video',
      badge: 'https://img.shields.io/badge/IA-Video-8A2BE2?logo=ai&logoColor=white&style=for-the-badge',
      localVideo: 'assets/iavideo.mp4',  // ✅ Ajouté ici
      type: 'local'
    },
    {
      title: 'E-Commerce',
      ...
      localVideo: 'assets/evideo.mp4',  // ✅ Corrigé
      type: 'local'
    },
    {
  ...
  sanitizeUrl(videoId: string | undefined, type: string, localVideo?: string): SafeResourceUrl | undefined {
    if (type === 'local' && localVideo) {
      return this.sanitizer.bypassSecurityTrustResourceUrl(localVideo);
    }
